(function (window) {
    ...
    var HZRecorder = function (stream, config) {
        ...
        this.stop = function () {
            ...
            au.controls = true;
            au.src = window.URL.createObjectURL(this.getBlob());
            li.appendChild(au);
        ...
        //上传
        this.upload = function (url, userid, callback) {
            var fd = new FormData();
            fd.append("user_id", "123123123123", "person_id", "123321123321",
                "telnum", "13700000000", "source", "456456456456", "policy_number", "789789789789",
                "nas_dir", "/asdf/asdf", "response_num", "654321987", "file", this.getBlob(), "name", userid + ".wav"); // filename: "123.wav"
